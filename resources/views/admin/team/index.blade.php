...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
       ...
       @foreach($team as $item)
           <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
               ...
               <td class="px-6 py-4">
                   ...
                   <a href="#" type="button" data-modal-target="{{ $item->title }}" data-modal-show="{{ $item->title }}" class="font-medium text-green-600 dark:text-green-500 hover:underline">Edit</a>
   ...
   @foreach($team as $item)
   <div id="{{ $item->title}}" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 items-center justify-center hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
       <div class="relative w-full max-w-2xl max-h-full">
           <!-- Modal content -->
...
<script>
    $(document).ready(function() {
        $('#myTable').DataTable({
            ...
            lengthMenu: [-1, 10, 20, 50, 100], // Set entries per page to 6
            pageLength: -1,
            responsive: true
        });
    });
