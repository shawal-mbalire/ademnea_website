        ...
        <div class="row no-gutters">
            <div class="col-lg-4 col-md-6">
                <div class="icon-box">
                    ...
                    <h4 class="title"><a href="">Networks and Resilience</a></h4>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="icon-box">
                    ...
                    <h4 class="title"><a href="">Data Analytics for Environment Monitoring services</a></h4>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="icon-box">
                    ...
                    <h4 class="title"><a href="">Sensors and signal processing </a></h4>
