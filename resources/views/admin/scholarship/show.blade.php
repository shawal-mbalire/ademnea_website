      ...
      <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/admin/scholarship') }}" title="Back"><button class="button2"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button></a>
                        <a href="{{ url('/admin/scholarship/' . $scholarship->id . '/edit') }}" title="Edit scholarship"><button class="button1"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
