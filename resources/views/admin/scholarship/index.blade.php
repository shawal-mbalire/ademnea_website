                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Category</th><th>Task</th><th>Topic</th><th>Deliverables</th><th>Competence</th><th>Instructions</th><th>Number Of Positions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($scholarship as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/admin/scholarship/' . $item->id) }}" title="View Scholarship"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/admin/scholarship/' . $item->id . '/edit') }}" title="Edit Scholarship"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
